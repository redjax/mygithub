...
def convert_github_starred_repo_schema_to_db_model(starred_repo: GithubStarredRepoIn) -> GithubStarredRepositoryModel:
...
def convert_github_repository_owner_schema_to_db_model(owner: GithubRepositoryOwnerIn) -> GithubRepositoryOwnerModel:
...
def convert_github_repository_owner_db_model_to_schema(owner_model: GithubRepositoryOwnerModel) -> GithubRepositoryOwnerOut:
    owner: GithubRepositoryOwnerOut = GithubRepositoryOwnerOut.model_validate(owner_model.__dict__)
